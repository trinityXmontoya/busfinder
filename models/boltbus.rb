class BoltBus
  ...
  def self.search
    ...
    b.link(id: "ctl00_cphM_forwardRouteUC_lstOrigin_repeater_ctl01_link").when_present.click
    b.image(id: "ctl00_cphM_forwardRouteUC_lstDestination_imageE").when_present.click
    b.link(id: "ctl00_cphM_forwardRouteUC_lstDestination_repeater_ctl00_link").when_present.click
    table = b.table(class: "fareview").html
    doc = Nokogiri::HTML.parse(table)

    boston = "ctl00_cphM_forwardRouteUC_lstOrigin_repeater_ctl01_link"
    new york = "ctl00_cphM_forwardRouteUC_lstOrigin_repeater_ctl04_link"


    b.link(id: 'ctl00_cphM_forwardRouteUC_lstRegion_repeater_ctl02_link').when_present.click
